...
function EditAddress(props) {
          ...
          const createEditJSX = <div>
                ...
                <button id="edit-address-save" onClick={() => props.updateAddress(addressInputState)} className="btn btn-primary">Save Changes</button>
          </div>

     return <div>
         <button id="edit-address-edit" className="btn btn-outline-primary" onClick={() => setEditToggleState(!editToggleState) }>Edit Address</button>
